...
Phase 2.7: Updated to Thesis Matrix JSON format.
The system prompt now requires thesisInsights (5 groups × N rows each)
and executionPlan (criteria + alerts or ladder depending on verdict).
"""
