...
# ─── SMA Signal ───────────────────────────────────────────────────────────────
# Canonical implementation moved to app.ota_adapters._shared.sma (OTA-717).
# Re-exported here for backward compatibility with analysis_routes.py.

from app.ota_adapters._shared.sma import compute_sma_signal  # noqa: E402, F401
